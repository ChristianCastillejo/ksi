  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap tracking-widest uppercase rounded-[var(--radius-interaction)] text-sm font-medium ring-offset-white transition-colors transition duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:bg-white hover:text-foreground",
  ...
  (
    ...
    return (
      ...
      >
        ...
        <span className={cn("flex items-center gap-2 transition-opacity", isLoading && "opacity-80")}>
          {children}
        </span>
      </button>
    );
