...
export interface StorebookHeroContent {
    tagline: string;
    titleMain: string;
    titleItalic: string;
    description: string;
...
export const StorebookHero = ({ content }: { content: StorebookHeroContent }) => {
    return (
        <section className="relative w-full pt-32 pb-24 bg-background border-b border-border/40 mb-16 flex flex-col items-center text-center px-6">
            <motion.span
