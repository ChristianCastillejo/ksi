...
export interface HeroAshramsContent {
    tagline: string;
    titleMain: string;
    titleItalic: string;
    description: string;
...
interface HeroAshramsProps {
    scrollYProgress: MotionValue<number>;
    content: HeroAshramsContent;
}

export const HeroAshrams = ({ scrollYProgress, content }: HeroAshramsProps) => {
            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
                <motion.div style={{ y: yText }} className="flex flex-col items-center">
                    ...
                    <motion.h1
                        ...
                        className="font-serif text-6xl md:text-8xl lg:text-[120px] text-foreground leading-[0.9] tracking-tight"
                    >
                        {content.titleMain}
